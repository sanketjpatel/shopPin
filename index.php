  ...
  var items = data.findItemsByKeywordsResponse[0].searchResult[0].item || [];
          ...
          for (var i = 0; i < items.length; ++i) {
            ...
            if (null != title && null != viewitem) {
              ...
              html.push('<li data-bestMatch="'+ count+'" data-price="'+itemPrice+'" data-name="'+title+'">' + '<p>'+currency+" "+itemPrice+'</p>'+'<a href="' + viewitem + '" target="_blank">' + '<img src="' + pic + ' height="120" width="170" " ' + '<  rel="lightbox" /a><p style="width:140px;">'+" "+title+'</p></li>');
              count++;
            }
          }
